...
export function Breadcrumbs({ items, actions }: BreadcrumbsProps) {
  return (
    <div className="z-10 flex items-center justify-between w-full px-4 py-2 font-mono font-bold uppercase border-b shadow-sm h-14 whitespace-nowrap bg-background">
