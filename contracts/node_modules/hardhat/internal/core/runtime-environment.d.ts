...
export declare class Environment implements HardhatRuntimeEnvironment {
     ...
     */
    constructor(config: HardhatConfig, hardhatArguments: HardhatArguments, tasks: TasksMap, extenders?: EnvironmentExtender[], experimentalHardhatNetworkMessageTraceHooks?: ExperimentalHardhatNetworkMessageTraceHook[], userConfig?: HardhatUserConfig);
    /**
