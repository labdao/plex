...
require (
	...
	github.com/bacalhau-project/bacalhau v0.3.28 // indirect
...
replace plex/gateway/handlers => ../handlers

replace plex/gateway/models => ../models

replace plex/gateway/server => ../server
