CREATE TABLE user_datafiles (
    ...
    CONSTRAINT pk_user_datafiles PRIMARY KEY (wallet_address, data_file_c_id),
    CONSTRAINT fk_user_datafiles_wallet_address FOREIGN KEY (wallet_address) REFERENCES users(wallet_address),
    CONSTRAINT fk_user_datafiles_data_file FOREIGN KEY (data_file_c_id) REFERENCES data_files(cid)
);

INSERT INTO user_datafiles (wallet_address, data_file_c_id, created_at)
