...
# Print CSV header
echo "Filename,Ligand,Model,Affinity,rmsd l.b.,rmsd u.b.,inter_intra,inter,intra,unbound" > $output_file
...
for pdbqt_file in $input_dir/*.pdbqt; do
    ...
    awk -v ligand="$ligand" -v file="$pdbqt_file" '
        ...
        /REMARK UNBOUND/ {unbound=$3; print file","name","model","affinity","rmsd_lb","rmsd_ub","inter_intra","inter","intra","unbound}
