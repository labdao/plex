...
"pdb_checkpoint_1": "/inputs/pdb_checkpoints/example.pdb",
"pdb_checkpoint_2": "/inputs/pdb_checkpoints/design_1.pdb",
"pdb_checkpoint_3": "/inputs/pdb_checkpoints/BioCD202b18_aa_7fd4f_unrelaxed_rank_003_alphafold2_multimer_v3_model_2_seed_000.pdb",}' \
-e JOB_UUID='1234' \
--env-file ~/aws.env \
