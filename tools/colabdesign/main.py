...
def prodigy_run(csv_path, pdb_path):
    ...
    for i, r in df.iterrows():
        ...
        try:
            ...
            print(f"Warning: Prodigy command failed for {file_path}. This is not an error per se but most likely due to the binder not being closely positioned against the target.")
