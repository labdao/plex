...
var initCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		ioJson, err := InitializeIo(toolPath, scatteringMethod, kwargs)
		if err != nil {
			log.Fatal(err)
		}
...
func validateInputKeys(inputVectors map[string][]string, toolInputs map[string]ipwl.ToolInput) error {
...
func createSingleIo(inputs []string, tool ipwl.Tool, toolInfo ipwl.ToolInfo, userId string, inputVectors map[string][]string) (ipwl.IO, error) {
	io := ipwl.IO{
		Tool:    toolInfo,
