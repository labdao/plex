...
func init() {
	runCmd.Flags().StringVarP(&toolPath, "toolPath", "t", "", "Path to the tool")
	runCmd.Flags().StringVarP(&inputDir, "inputDir", "i", "", "Directory of input")
	...
	runCmd.Flags().BoolVarP(&local, "local", "l", false, "Use local resources")
	...
	runCmd.Flags().IntVarP(&layers, "layers", "L", 1, "Number of layers")
